  ...
  return (
    <Listbox onChange={handleSelect} value={selected}>
      <div className="relative">
        <Listbox.Button className="relative w-full flex justify-between items-center p-4 cursor-default focus:outline-none border border-red rounded-rounded bg-rose-100">
          {({ open }) => (
            <>
