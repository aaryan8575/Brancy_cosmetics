...
//   console.log(data.heading1)
  return (
    <div className="flex flex-col items-center justify-center w- flex-1 px-4 text-center  bg-gradient-to-r from-white from-10% via-white via-40% to-em-200 h-screen">
